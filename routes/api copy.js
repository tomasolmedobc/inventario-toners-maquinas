...
router.get('/api/equipos', equipoController.listarEquipos);
router.get('/api/equipos/filtros', equipoController.obtenerFiltros);
router.post('/api/equipos', equipoController.crearEquipo);
